...
df = pd.read_csv('/home/client-014/Documents/1minstock.csv', sep=",")
...
def update_fig(input_value):
    if input_value is not None:
        ...
        numpy.savetxt("/home/client-014/Pictures/stock/y_test.csv", y_test, delimiter="]")
        numpy.savetxt("/home/client-014/Pictures/stock/Lstmpredicted_price.csv", predicted_price, delimiter="]",header='a')
        df1 = open('/home/client-014/Pictures/stock/y_test.csv', 'r').readlines()
        df2 = pandas.read_csv('/home/client-014/Pictures/stock/Lstmpredicted_price.csv')

        filename = 1
        for i in range(len(df1)):
            if i % 1000 == 0:
                open(str('/home/client-014/Pictures/stock/Lstm1') + '.csv', 'w+').writelines(
                    df1[i:i + 100])

        filename += 2
        for i in range(len(df1)):
            if i % 1000 == 100:
                open(str('/home/client-014/Pictures/stock/Lstm2') + '.csv', 'w+').writelines(
                    df1[i:i + 500])

        f1 = pandas.read_csv('/home/client-014/Pictures/stock/Lstm1.csv', header=None)
        f2 = pandas.read_csv('/home/client-014/Pictures/stock/y_test.csv', header=None)
        ...
        numpy.savetxt("/home/client-014/Pictures/stock/y_test.csv", y_test, delimiter="]")
        numpy.savetxt("/home/client-014/Pictures/stock/GRUpredicted_price.csv", predicted_with_gru, delimiter="]",
                      header='a')
        df1 = open('/home/client-014/Pictures/stock/y_test.csv', 'r').readlines()
        df3 = pandas.read_csv('/home/client-014/Pictures/stock/GRUpredicted_price.csv')
        ...
        numpy.savetxt("/home/client-014/Pictures/stock/y_test.csv", y_test, delimiter="]")
        numpy.savetxt("/home/client-014/Pictures/stock/rnnpredicted_price.csv", LG_predicted_stock_price, delimiter="]",
                      header='a')
        df5 = pandas.read_csv('/home/client-014/Pictures/stock/y_test.csv')
        df4 = pandas.read_csv('/home/client-014/Pictures/stock/rnnpredicted_price.csv')
